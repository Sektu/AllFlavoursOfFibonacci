...
test('tests of fibo2', () => {
    ...
    Object.keys(fiboResultsAdvanced).forEach((key) => {
        expect(BigInt(fibos.fibo2(parseInt(key)))).toBe(fiboResultsAdvanced[key]);
    });
});
...
test('tests of fibo3', () => {
    ...
    Object.keys(fiboResultsAdvanced).forEach((key) => {
        expect(BigInt(fibos.fibo3(parseInt(key)))).toBe(fiboResultsAdvanced[key]);
    });
});
